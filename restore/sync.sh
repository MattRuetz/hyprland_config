...
cp ~/.local/bin/{classical-paintings-download,classical-paintings-expand,classical-paintings-expand-japanese,classical-paintings-expand-v3,classical-paintings-next,classical-paintings-remove,cdsp,nightlight-adjust,autoclicker,autoclicker.py,flstudio,ss,sudo-askpass} bin/
